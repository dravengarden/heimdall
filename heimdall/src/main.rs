...
//! ## Configuration
//!
//! Driven by `/etc/heimdall/heimdall.{ncl,toml,json,yaml}` (auto-discovered).
//! See `heimdall-config` crate for schema, and `/etc/heimdall/README.md`
//! (auto-generated by `heimdall init`) for the AI-readable reference.
...
///   `heimdall help flows`        concise help for the flows verb
///   `heimdall help flows -v`     verbose: flows + list/show/search inlined
///   `heimdall help flows list`   concise help for the leaf
///
