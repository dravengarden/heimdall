...
//!
//! Resolution order (matches the doc at /etc/<host-config>/docs/heimdall.md):
//!
...
mod tests {
    ...
    fn make_cfg() -> HeimdallConfig {
        ...
        let mut corp_labels = BTreeMap::new();
        corp_labels.insert("family".to_string(), "corp".to_string());

        let rules = vec![Rule {
            name: "corp-family".into(),
            r#match: Match {
                match_labels: corp_labels,
    ...
    fn namespace_filter() {
        ...
        let p_in = PodInfo {
            ...
            labels: [("family".to_string(), "corp".to_string())].into(),
            ..Default::default()
        };
        let p_out = PodInfo {
