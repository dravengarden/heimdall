...
Roadmap (not yet shipped): M5 MITM (TLS terminator + dynamic cert
mint + HAR-format flow log), M6 storage (sqlite + blob with 3-day
retention — partially landed), M7 Web UI improvements, M8 MCP /
agent integration.
