...
- [design/macos-backend.md](design/macos-backend.md) — Apple-silicon interpose, architecture-neutral explicit, native package boundary, and deferred Network Extension prototype
- [design/macos-fallbacks.md](design/macos-fallbacks.md) — evaluated fallback strategies, implemented daemonless interpose architecture, exact bypasses, and remaining acceptance work
...
- [runbook.md](runbook.md) — build, x86_64/aarch64 Darwin type-checks plus native explicit and Apple-silicon interpose/deferred-companion/package gates, x86_64 NixOS/Ubuntu/Debian functional and performance VM gates, native-aarch64 acceptance, Agent v10, lifecycle, and troubleshooting
