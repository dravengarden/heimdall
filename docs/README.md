...
- [install.md](install.md) — native, npm, and PyPI x86_64/aarch64 static Linux releases, checksum verification, setup authorization, upgrade, and rollback
- [runbook.md](runbook.md) — build, agent JSON contract, lifecycle, and troubleshooting
- [releasing.md](releasing.md) — curated changelog, local release assets, release-triggered npm/PyPI OIDC publication, and verification standard
