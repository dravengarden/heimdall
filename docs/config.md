...
```
        ...
        │         │                      │                      │
        │  proxy  │                      │                      │
        │ conviva │ proxy via Mac        │ proxy via Mac        │
        │         │ + capture plaintext  │ + no plaintext       │
        │         │                      │                      │
...
`heimdall.io/connection: conviva` keeps `observe` from whatever rule
or default applies.
...
match:
  ...
  namespaces: [conviva-prod, conviva-stg]
```
...
metadata:
  annotations:
    heimdall.io/connection: conviva     # route this pod via Mac
