...
- [`runbook.md`](runbook.md) — Build, setup authorization, offline agent/log schemas, daemonless operation, TLS, x86_64 and native-aarch64 current/LTS VM gates, and performance baseline
