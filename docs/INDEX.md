...
- [`design/daemonless-runtime.md`](design/daemonless-runtime.md) — Foreground per-run architecture and implementation status for session-owned listeners, DNS, and eBPF links
...
- [`design/daemonless-runtime.md`](design/daemonless-runtime.md) — Accepted replacement for the persistent daemon; session resource and FD-owned link groundwork is implemented, while `heimdall run` ownership remains in development
