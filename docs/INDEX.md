...
- [`releasing.md`](releasing.md) — Curated changelog, local GitHub assets, release-triggered npm/PyPI/crates.io OIDC publication, and post-publication verification standard
...
- [`releasing.md`](releasing.md) — Required release body, local GitHub artifacts, release-triggered npm/PyPI/crates.io publication, and post-publication verification
