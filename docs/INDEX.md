...
- [`runbook.md`](runbook.md) — Build, setup authorization, offline agent/log schemas, daemonless operation, TLS, x86_64 NixOS/Ubuntu and native-aarch64 VM gates, four package gates, and performance baseline
