...
- [`ROADMAP.md`](../ROADMAP.md) — Public status, NixOS/Ubuntu lifecycle, fake-DNS and TLS compatibility, release artifact hygiene and native ARM work, planned macOS wrapper/Network Extension backends, and roadmap
