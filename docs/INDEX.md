...
- [`design/agent-event-log.md`](design/agent-event-log.md) — Agent-first event storage and CLI contract with lifecycle, DNS/policy/TLS observations, payload allowlists/redaction, and content-addressed blobs
