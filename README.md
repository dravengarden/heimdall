...
| macOS support | In development, not available | Darwin config/init and an unavailable `heimdall.agent/v8` preflight now type-check without Linux dependencies; proxy execution, packaging, the signed companion, and native acceptance remain incomplete |
