...
```bash
heimdall run -p conviva --print-decision -- echo unused
# {
#   "connection": "conviva",
#   "observe": true,
#   "dns": "fake",
...
```bash
heimdall run -p conviva -- curl -ksSm 5 https://vault.prod.conviva.com/
# tunnel established connection=conviva dst=vault.prod.conviva.com
#                    via=192.168.0.155:1080
```
