...
Require its embedded `heimdall.daemon.health/v1` document to be ready and to
match the configured decrypt mode; transparent capture additionally requires a
...
For an explicitly approved MITM setup, generate trust material without shell
evaluation:
